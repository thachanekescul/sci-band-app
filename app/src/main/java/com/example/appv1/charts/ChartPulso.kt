// File: app/src/main/java/com/example/appv1/admin/charts/ChartPulso.kt
...
class ChartPulso(
    ...
    fun loadChart() {
        val layout = LayoutInflater.from(context)
            .inflate(R.layout.item_grafica_hr, container, false) as LinearLayout
        ...
        fun updateChart(days: Int, ids: List<String>) {
            ...
            val tasks = ids.map { collectionRef.document(it).get() }
            ...
            Tasks.whenAllSuccess<DocumentSnapshot>(tasks)
                .addOnSuccessListener { results ->
                    ...
                    for ((index, id) in ids.withIndex()) {
                        ...
                        val valor = doc.getLong("p")?.toFloat()
                        if (valor != null) mapaOrdenado[id] = valor
                    }
