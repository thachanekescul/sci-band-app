...
class ChartAsistencias(
    ...
    fun loadChart() {
        ...
        Mensaje.text= "Asistencias Hechas"
        fun updateChart(days: Int, ids: List<String>) {

            val collectionRef = db.collection(
                "organizacion/$organizacionId/cuidadores/$cuidadorId/asistencias"
            )
            ...
            Tasks.whenAllSuccess<DocumentSnapshot>(tasks)
                .addOnSuccessListener { results ->
                    ...
                    for ((index, id) in ids.withIndex()) {
                        ...
                        val valor = doc.getLong("asistencia")?.toFloat()
                        if (valor != null) {
