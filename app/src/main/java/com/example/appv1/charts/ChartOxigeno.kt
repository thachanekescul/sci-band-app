// File: app/src/main/java/com/example/appv1/admin/charts/ChartOxigeno.kt
...
class ChartOxigeno(
    ...
    fun loadChart() {
        val layout = LayoutInflater.from(context)
            .inflate(R.layout.item_grafica_ox, container, false) as LinearLayout
            ...
            Tasks.whenAllSuccess<DocumentSnapshot>(tasks)
                .addOnSuccessListener { results ->
                    ...
                    for ((index, id) in ids.withIndex()) {
                        ...
                        val valor = doc.getLong("o")?.toFloat()
                        if (valor != null) {
